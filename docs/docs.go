    ...
    "paths": {
        ...
        "/carousel": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entity.Carousel"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Carousel slide data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.DoctorCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.DoctorUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entity.License"
                            }
                        }
                    }
                }
        ...
        "/service-categories/{id}/favorite": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.ServiceCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/specializations": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entity.Specialization"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Specialization data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
